    ...
    class AnimatedSVGPath extends Polymer.Element {
        ...
        play() {
            ...
            requestAnimationFrame(() => {
                ...
                const maxPathLength = paths.map(p => p.getTotalLength()).reduce((val, next) => next > val ? next : val);
                ...
                const _do = () => {
                    ...
                    const len = paths.map(p => p.getTotalLength()).reduce((val, next, i) => val += next / (i + 1), 0);
